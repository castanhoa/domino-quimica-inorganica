...
CREATE TABLE IF NOT EXISTS aluno (
    ...
    email_aluno VARCHAR(75) PRIMARY KEY NOT NULL,
...
CREATE TABLE IF NOT EXISTS professor (
    ...
    email_prof VARCHAR(75) PRIMARY KEY NOT NULL,
    hash_senha_prof CHAR(64) CHARACTER SET ascii COLLATE ascii_bin NOT NULL
    
);

-- Para fins de testes
INSERT IGNORE INTO aluno VALUES(
...
INSERT IGNORE INTO professor VALUES (
"Rogério Matos Rei",
"456@cps.sp.gov.br",
